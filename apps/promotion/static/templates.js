...
const default_input_fields = [
  ...
  },
  {
    ...
    style: {
      ...
      border: "none",
      "box-shadow":
        "inset 1px 1px rgba(255, 255, 255, 0.1), 2px 2px 1px 1px rgba(0, 0, 0, 0.1)",
...
const templates = [
  {
    ...
    containerStyle: {
      ...
      "border-radius": "16px",
      "box-shadow":
        "0 14px 40px rgba(0, 0, 0, 0.12), 0 0 0 1px rgba(0, 0, 0, 0.06)",
      overflow: "hidden",
      "overflow-x": "hidden",
      "overflow-y": "auto",
    ...
    game_styles: {
      game_svg:
        "display: block ; box-sizing: border-box ; max-width: 100% ; max-height: 100% ; width: auto ; height: auto ; flex-shrink: 1 ;",
      ...
      left: {
        ...
        game_inner:
          "width: 100% ; height: 100% ; min-height: 0 ; flex: 1 1 auto ; display: flex ; align-items: center ; justify-content: center ; box-sizing: border-box ; overflow: hidden ; padding: 8px ;height: 100%;",
      },
      top: {
    ...
    image_styles: {
      left: {
        image:
          "display: flex ; flex-direction: column ; flex: 0 0 0 ; width: 0 ; max-width: 0 ; min-width: 0 ; overflow: hidden ; padding: 0 ; margin: 0 ;",
        image_inner:
    ...
    top_image: {
      path: "",
      style:
        "position:absolute;left:50%;top:0;transform:translateX(-50%);width:min(92%,720px);max-height:26%;height:auto;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:min(92%,720px);max-height:24%;height:auto;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // pink — tema 101 ile aynı kabuk/layout/stiller; arka plan görseli ve gameColors pembe
  {
    ...
    top_image: {
      path: "",
      style:
        "position:absolute;left:50%;top:0;transform:translateX(-50%);width:min(90%,680px);max-height:25%;height:auto;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:min(90%,680px);max-height:23%;height:auto;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // green — tema 101 ile aynı kabuk/layout/stiller; template2 arka plan, gameColors yeşil
  {
    ...
    top_image: {
      path: "",
      style:
        "position:absolute;left:50%;top:0;transform:translateX(-50%);width:min(88%,660px);max-height:27%;height:auto;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:min(88%,660px);max-height:22%;height:auto;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // happy halloween 1 — tema 101 ile aynı kabuk; üst/alt dekor görselleri korunur
  {
    ...
    top_image: {
      ...
      style:
        "position:absolute;left:50%;top:1%;transform:translateX(-50%);width:340px;max-width:min(92%,720px);height:auto;max-height:30%;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "static/images/templates/happyHalloween/bottom-image.png",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:340px;max-width:min(92%,720px);height:auto;max-height:30%;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // happy halloween 2
  {
    ...
    top_image: {
      path: "",
      style:
        "position:absolute;left:50%;top:0;transform:translateX(-50%);width:min(91%,700px);max-height:26%;height:auto;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "static/images/templates/happyHalloween2/bottom-image.png",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:340px;max-width:min(92%,720px);height:auto;max-height:29%;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // valentines day
  {
    ...
    top_image: {
      ...
      style:
        "position:absolute;left:50%;top:1%;transform:translateX(-50%);width:340px;max-width:min(94%,760px);height:auto;max-height:28%;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "static/images/templates/valentinesDay/bottom-image.png",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:340px;max-width:min(94%,760px);height:auto;max-height:28%;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // black friday 1 — tema 101 ile aynı kabuk; üst/alt dekor görselleri korunur
  {
    ...
    top_image: {
      ...
      style:
        "position:absolute;left:50%;top:1%;transform:translateX(-50%);width:340px;max-width:min(93%,740px);height:auto;max-height:29%;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "static/images/templates/black-friday1/bottom-image.png",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:340px;max-width:min(93%,740px);height:auto;max-height:26%;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  {
    id: 108,
    ...
    top_image: {
      ...
      style:
        "position:absolute;left:50%;top:1%;transform:translateX(-50%);width:340px;max-width:min(91%,710px);height:auto;max-height:28%;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "static/images/templates/black-friday2/bottom-image.png",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:340px;max-width:min(91%,710px);height:auto;max-height:27%;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  {
    id: 109,
    ...
    top_image: {
      ...
      style:
        "position:absolute;left:50%;top:1%;transform:translateX(-50%);width:340px;max-width:min(95%,780px);height:auto;max-height:30%;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "static/images/templates/christmas/bottom-image.png",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:340px;max-width:min(95%,780px);height:auto;max-height:25%;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  {
    id: 110,
    ...
    top_image: {
      ...
      style:
        "position:absolute;left:50%;top:1%;transform:translateX(-50%);width:340px;max-width:min(92%,720px);height:auto;max-height:28%;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:min(89%,700px);max-height:23%;height:auto;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // mother day — tema 101 ile aynı kabuk; arka plan ve gameColors korunur
  {
    ...
    top_image: {
      path: "",
      style:
        "position:absolute;left:50%;top:0;transform:translateX(-50%);width:min(93%,730px);max-height:25%;height:auto;object-fit:contain;object-position:center top;pointer-events:none;",
    },
    bottom_image: {
      path: "",
      style:
        "position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:min(93%,730px);max-height:24%;height:auto;object-fit:contain;object-position:center bottom;pointer-events:none;",
    },
  },
  // Scratch Card Basic Design
  {
    id: 201, // Scratch Card şablonları 200'den başlasın
    name: "Scratch Card Basic",
    categories: ["Scratch Card", "Modern"],
    popup_type: "gaming",
    hasGame: true,
    thumbnail: "",
    gameID: 2, // BURASI ÇOK ÖNEMLİ: Bu şablonun Scratch Card (id:2) olduğunu belirtir
    containerStyle: {
      display: "flex",
      "flex-direction": "column",
      "align-items": "stretch",
      ...
      width: "980px",
      height: "580px",
      background: "#f0f4f8", // Farklı bir arka plan rengi
      "border-radius": "16px",
      "box-shadow":
        "0 14px 40px rgba(0, 0, 0, 0.12), 0 0 0 1px rgba(0, 0, 0, 0.06)",
      overflow: "hidden",
    ...
    texts: {
      ...
      description:
        "Scratch the card below to reveal your surprise discount. Everyone is a winner!",
      disclaimer: "You can scratch only once. Good luck!",
    },
    text_styles: {
      headline: { ...default_text.styles.headline, color: "#1a1a1a" },
      description: { ...default_text.styles.description, color: "#4a4a4a" },
      disclaimer: { ...default_text.styles.disclaimer, color: "#6a6a6a" },
    },
    close_button: {
      type: "icon",
      position: "top-right",
      style:
        "position:absolute; right:12px; top:10px; width:32px; height:32px; background:rgba(0,0,0,0.1); border-radius:50%; color:#1a1a1a; font-size:18px; display:flex; align-items:center; justify-content:center; cursor:pointer; z-index:10;",
    },
    game_styles: {
      game_svg:
        "display: block ; box-sizing: border-box ; max-width: 100% ; max-height: 100% ; width: auto ; height: auto ; flex-shrink: 1 ;",
      game_svg_area: "height: 80%",
      gameBackground: "transparent",
      gameOpacity: 0,
      game_svg_text: {
        "font-family": "Arial",
        "font-size": "26px",
    ...
    content_styles: JSON.parse(JSON.stringify(default_content_styles)),
    image_styles: {
      left: { image: "display: none;", image_inner: "display: none;" },
      top: { image: "display: none;", image_inner: "display: none;" },
      right: { image: "display: none;", image_inner: "display: none;" },
    },
    input_fields: defaultGamingTemplateInputFields(),
    gameColors: {
      "--primary-color": "#00C39A",
